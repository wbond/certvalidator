...
def verify_crl(cert, path, validation_context, use_deltas=True, cert_description=None, end_entity_name_override=None):
    ...
    while len(crls_to_process) > 0:
        ...
        # according to RFC 5280 5.1.2.5 next_update is optional
        if certificate_list['tbs_cert_list']['next_update'] and \
           moment > certificate_list['tbs_cert_list']['next_update'].native:
            failures.append((
